...
RUN DEBIAN_FRONTEND=noninteractive apt install -y procps psutils sudo nano systemd \
        at-spi2-core wget net-tools locales tar bzip2 ttf-ubuntu-font-family \
        ttf-wqy-zenhei fonts-noto-color-emoji libxt6 rsync xorg jq
...
RUN env DEBIAN_FRONTEND=noninteractive apt-get install -y \
        ...
        libvulkan1 vulkan-utils libvulkan1:i386 libgl1-mesa-dri:i386 \
